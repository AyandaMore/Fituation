...
{
    public abstract class FituationAPIWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static FituationAPIWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(FituationAPIWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<FituationAPIDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<FituationAPIDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<FituationAPIDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<FituationAPIDbContext, Task<T>> func)
        {
            T result;
